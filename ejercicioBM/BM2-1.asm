...
main PROC
    ...
    printInverseTemperature:
        ...
        .WHILE EAX <= nTemp
            ...
            inc EBX
            .WHILE EBX <= n
                mov ECX, temperatures[EAX * TYPE temperatures]
                .IF SDWORD PTR ECX > temperatures[EBX * TYPE temperatures]
                    XCHG ECX, temperatures[EBX * TYPE temperatures]
                    mov temperatures[EAX * TYPE temperatures], ECX
                .ENDIF
                inc EBX
            .ENDW
            inc EAX
